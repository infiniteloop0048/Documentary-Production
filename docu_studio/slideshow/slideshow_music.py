...
path. Jamendo search+cache+fetch (JamendoMusicProvider, TrackCandidate) comes
from the shared docu_studio.common.music_jamendo module. LocalFolderMusicProvider
wraps a user-browsed folder rather than Shorts' bundled assets/music/
manifest, since Slideshow ships no bundled tracks (Phase 3 design decision).
